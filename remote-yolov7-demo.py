...
def main():
    ...
    #title
    st.title('Bovine Detection and Tracking Dashboard')
    ...
    use_webcam = st.sidebar.checkbox('Use Remote Cam')
    ...
    custom_classes = True #= st.sidebar.checkbox('Use Custom Classes')
    assigned_class_id = []
    if custom_classes:
        assigned_class = st.sidebar.multiselect('Select The Custom Classes',list(names),default='cow')
        #assigned_class = ["cows"]
    ...
    DEMO_VIDEO = 'Pexels Videos 3653-2.mp4'
    ...
    ##TODO Send out to remote server
